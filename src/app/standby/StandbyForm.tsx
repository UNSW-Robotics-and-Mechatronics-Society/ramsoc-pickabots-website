...
export default function StandbyForm() {
  ...
  // The code is never held in the client — it's posted to /api/access, which
  // compares it server-side and sets the httpOnly access cookie on success.
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          {unlocked ? '✓  ACCESS GRANTED' : checking ? 'CHECKING…' : 'ENTER 6-CHARACTER CODE'}
        </div>
