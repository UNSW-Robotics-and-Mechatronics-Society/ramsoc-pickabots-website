...
export const SCREEN_SCENES = ["Sumobots", "Intermission", "Bracket", "Finals", "Standings", "Leaderboard", "Results", "All Rings", "Vote", "Commentary", "Timeout", "Rambo Returns", "Standby", "Blank"] as const;
